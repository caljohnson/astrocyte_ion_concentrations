...
% from Egger & Niggli 1999 (based on DiFrancesco & Noble, 1985)
...
line([0,0],[-3e-9,2e-9],'LineStyle','--', 'Color', 'k','HandleVisibility','off');

saveas(fig,'figs/egger_niggli_1999_model_figs/egger_niggli_1999_model_IV_curve_vsCain.png');
...
lgd.Location = 'southeast';
line([-100,50],[0,0],'LineStyle','--', 'Color', 'k','HandleVisibility','off');
line([0,0],[-3e-9,5e-9],'LineStyle','--', 'Color', 'k','HandleVisibility','off');

saveas(fig,'figs/egger_niggli_1999_model_figs/egger_niggli_1999_model_IV_curve_vsNain.png');
...
saveas(fig,'figs/egger_niggli_1999_model_figs/egger_niggli_1999_model_saturationcurves.png');
