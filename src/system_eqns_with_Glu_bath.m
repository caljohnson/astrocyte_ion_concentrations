function [dX_dt] = system_eqns_with_Glu_bath(t,X,Glu_bath,Ca_forcing)
%SYSTEM_EQNS creates system of differential equations for the
%            astrocyte ion concentration tracking model
%            with a prescribed Glu bath and Ca FORCING TERMS
%       dX/dt = F(X)
% where X = (Na_in, K_in, Ca_in, Na_out, K_out, Ca_out, Vm) 
%tracks changes in intra- and extra-cellular ion concentrations
%of extracellular ions:
%        K+, Ca2+, Na+ (K_out, Ca_out, Na_out)
...
%system form
%X = (Na_in, K_in, Ca_in, Na_out, K_out, Ca_out,Vm)
dX_dt = ...
    [dNa_in_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath(t), X(7)); ...
    dK_in_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath(t), X(7)); ...
    dCa_in_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath(t), X(7), Ca_forcing(t)); ...
    dNa_out_dt(X(1), X(2), X(3), X(4), X(5), X(6),Glu_bath(t), X(7)); ...
    dK_out_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath(t), X(7)); ...
    dCa_out_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath(t), X(7)); ...
    dVm_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath(t), X(7));];
