...
dX_dt = ...
    [dNa_in_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath, X(7)); ...
    dK_in_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath, X(7)); ...
    dCa_in_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath, X(7), Ca_forcing(t)); ...
    dNa_out_dt(X(1), X(2), X(3), X(4), X(5), X(6),Glu_bath, X(7)); ...
    dK_out_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath, X(7)); ...
    dCa_out_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath, X(7)); ...
    dVm_dt(X(1), X(2), X(3), X(4), X(5), X(6), Glu_bath, X(7));];
